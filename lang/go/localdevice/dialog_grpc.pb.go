...
const (
	DialogManager_Question_FullMethodName        = "/cloud.lazycat.apis.localdevice.DialogManager/Question"
	DialogManager_MessageBox_FullMethodName      = "/cloud.lazycat.apis.localdevice.DialogManager/MessageBox"
	DialogManager_Password_FullMethodName        = "/cloud.lazycat.apis.localdevice.DialogManager/Password"
	DialogManager_OpenFileSeletor_FullMethodName = "/cloud.lazycat.apis.localdevice.DialogManager/OpenFileSeletor"
)
...
func (c *dialogManagerClient) Question(ctx context.Context, in *QuestionRequest, opts ...grpc.CallOption) (*QuestionResult, error) {
	...
	err := c.cc.Invoke(ctx, DialogManager_Question_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dialogManagerClient) MessageBox(ctx context.Context, in *MessageBoxRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, DialogManager_MessageBox_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dialogManagerClient) Password(ctx context.Context, in *PasswordRequest, opts ...grpc.CallOption) (*PasswordResult, error) {
	...
	err := c.cc.Invoke(ctx, DialogManager_Password_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dialogManagerClient) OpenFileSeletor(ctx context.Context, in *OpenFileSeletorRequest, opts ...grpc.CallOption) (*OpenFileSeletorResult, error) {
	...
	err := c.cc.Invoke(ctx, DialogManager_OpenFileSeletor_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DialogManager_Question_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DialogManager_Question_FullMethodName,
	}
...
func _DialogManager_MessageBox_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DialogManager_MessageBox_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DialogManager_Password_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DialogManager_Password_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DialogManager_OpenFileSeletor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DialogManager_OpenFileSeletor_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var DialogManager_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "localdevice/dialog.proto",
}
