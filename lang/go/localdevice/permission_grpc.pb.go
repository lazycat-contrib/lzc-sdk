...
const (
	PermissionManager_GetPermission_FullMethodName     = "/cloud.lazycat.apis.localdevice.PermissionManager/GetPermission"
	PermissionManager_RequestPermission_FullMethodName = "/cloud.lazycat.apis.localdevice.PermissionManager/RequestPermission"
	PermissionManager_ListPermissions_FullMethodName   = "/cloud.lazycat.apis.localdevice.PermissionManager/ListPermissions"
	PermissionManager_RequestAuthToken_FullMethodName  = "/cloud.lazycat.apis.localdevice.PermissionManager/RequestAuthToken"
)
...
func (c *permissionManagerClient) GetPermission(ctx context.Context, in *PermissionRequest, opts ...grpc.CallOption) (*PermissionReply, error) {
	...
	err := c.cc.Invoke(ctx, PermissionManager_GetPermission_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *permissionManagerClient) RequestPermission(ctx context.Context, in *PermissionRequest, opts ...grpc.CallOption) (*PermissionReply, error) {
	out := new(PermissionReply)
	err := c.cc.Invoke(ctx, PermissionManager_RequestPermission_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *permissionManagerClient) ListPermissions(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListPermissionsReply, error) {
	...
	err := c.cc.Invoke(ctx, PermissionManager_ListPermissions_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *permissionManagerClient) RequestAuthToken(ctx context.Context, in *RequestAuthTokenRequest, opts ...grpc.CallOption) (*RequestAuthTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, PermissionManager_RequestAuthToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PermissionManager_GetPermission_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PermissionManager_GetPermission_FullMethodName,
	}
...
func _PermissionManager_RequestPermission_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PermissionManager_RequestPermission_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PermissionManager_ListPermissions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PermissionManager_ListPermissions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PermissionManager_RequestAuthToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PermissionManager_RequestAuthToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
