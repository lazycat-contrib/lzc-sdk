...
const (
	ClipboardManager_Read_FullMethodName  = "/cloud.lazycat.apis.localdevice.ClipboardManager/Read"
	ClipboardManager_Write_FullMethodName = "/cloud.lazycat.apis.localdevice.ClipboardManager/Write"
	ClipboardManager_Watch_FullMethodName = "/cloud.lazycat.apis.localdevice.ClipboardManager/Watch"
)
...
func (c *clipboardManagerClient) Read(ctx context.Context, in *ReadClipRequest, opts ...grpc.CallOption) (*ReadClipResponse, error) {
	out := new(ReadClipResponse)
	err := c.cc.Invoke(ctx, ClipboardManager_Read_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clipboardManagerClient) Write(ctx context.Context, in *WriteClipRequest, opts ...grpc.CallOption) (*WriteClipResponse, error) {
	...
	err := c.cc.Invoke(ctx, ClipboardManager_Write_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clipboardManagerClient) Watch(ctx context.Context, in *ReadClipRequest, opts ...grpc.CallOption) (ClipboardManager_WatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &ClipboardManager_ServiceDesc.Streams[0], ClipboardManager_Watch_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (x *clipboardManagerWatchClient) Recv() (*ReadClipResponse, error) {
	m := new(ReadClipResponse)
...
func _ClipboardManager_Read_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ClipboardManager_Read_FullMethodName,
	}
...
func _ClipboardManager_Write_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ClipboardManager_Write_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (x *clipboardManagerWatchServer) Send(m *ReadClipResponse) error {
