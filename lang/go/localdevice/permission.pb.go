...
const (
	...
	// 打开文件管理器的权限(读取文件，删除文件)
	Permission_FILE_HANLDER_PERMISSION Permission = 1
	// 打开第三方文件的权限(是否允许打开第三方应用(唤醒））
	Permission_OPEN_FILE_PERMISSION Permission = 2
)
...
var (
	Permission_name = map[int32]string{
		...
		1: "FILE_HANLDER_PERMISSION",
		2: "OPEN_FILE_PERMISSION",
	}
	Permission_value = map[string]int32{
		"PHOTO_LIBRAY_PERMISSION": 0,
		"FILE_HANLDER_PERMISSION": 1,
		"OPEN_FILE_PERMISSION":    2,
	}
)
...
const (
	// 已经授予
	PermissionResult_GRANTED PermissionResult = 0
	// 未授予
	PermissionResult_NO_GRANTED PermissionResult = 1
	// 未知
	PermissionResult_UN_KNOWN PermissionResult = 3
)

// Enum value maps for PermissionResult.
var (
	PermissionResult_name = map[int32]string{
		0: "GRANTED",
		1: "NO_GRANTED",
		3: "UN_KNOWN",
	}
	PermissionResult_value = map[string]int32{
		"GRANTED":    0,
		"NO_GRANTED": 1,
		"UN_KNOWN":   3,
	}
...
func (x PermissionResult) Enum() *PermissionResult {
	p := new(PermissionResult)
	*p = x
	return p
}
...
func (PermissionResult) Descriptor() protoreflect.EnumDescriptor {
	return file_localdevice_permission_proto_enumTypes[1].Descriptor()
}

func (PermissionResult) Type() protoreflect.EnumType {
	return &file_localdevice_permission_proto_enumTypes[1]
}

func (x PermissionResult) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PermissionResult.Descriptor instead.
func (PermissionResult) EnumDescriptor() ([]byte, []int) {
...
type CheckPermissionReply struct {
	...
	Reulst PermissionResult `protobuf:"varint,1,opt,name=reulst,proto3,enum=cloud.lazycat.apis.localdevice.PermissionResult" json:"reulst,omitempty"`
}
...
func (x *CheckPermissionReply) GetReulst() PermissionResult {
	if x != nil {
		return x.Reulst
	}
	return PermissionResult_GRANTED
}
...
var file_localdevice_permission_proto_rawDesc = []byte{
	...
	,
	...
	0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x34, 0x2e, 0x63, 0x6c, 0x6f, 0x75,
	0x64, 0x2e, 0x6c, 0x61, 0x7a, 0x79, 0x63, 0x61, 0x74, 0x2e, 0x61, 0x70, 0x69, 0x73, 0x2e, 0x6c,
	0x6f, 0x63, 0x61, 0x6c, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b,
...
var file_localdevice_permission_proto_goTypes = []interface{}{
	...
	(PermissionResult)(0),          // 1: cloud.lazycat.apis.localdevice.PermissionResult
...
var file_localdevice_permission_proto_depIdxs = []int32{
	...
	1, // 1: cloud.lazycat.apis.localdevice.CheckPermissionReply.reulst:type_name -> cloud.lazycat.apis.localdevice.PermissionResult
