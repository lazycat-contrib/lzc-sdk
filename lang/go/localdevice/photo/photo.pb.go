...
var file_localdevice_photo_photo_proto_rawDesc = []byte{
	...
	0x63, 0x61, 0x6c, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x41, 0x6c, 0x62, 0x75, 0x6d, 0x52,
...
var file_localdevice_photo_photo_proto_goTypes = []interface{}{
	(*PutPhotoReply)(nil),         // 0: cloud.lazycat.apis.localdevice.PutPhotoReply
	(*DeletePhotoReply)(nil),      // 1: cloud.lazycat.apis.localdevice.DeletePhotoReply
	(*DeletePhotoRequest)(nil),    // 2: cloud.lazycat.apis.localdevice.DeletePhotoRequest
	(*ListPhotoMetasRequest)(nil), // 3: cloud.lazycat.apis.localdevice.ListPhotoMetasRequest
	(*PhotoMeta)(nil),             // 4: cloud.lazycat.apis.localdevice.PhotoMeta
	(*Album)(nil),                 // 5: cloud.lazycat.apis.localdevice.Album
	(*ListAlbumsRequest)(nil),     // 6: cloud.lazycat.apis.localdevice.ListAlbumsRequest
	(*ListAlbumsReply)(nil),       // 7: cloud.lazycat.apis.localdevice.ListAlbumsReply
	(*PutPhotoRequest)(nil),       // 8: cloud.lazycat.apis.localdevice.PutPhotoRequest
	(*timestamppb.Timestamp)(nil), // 9: google.protobuf.Timestamp
}
var file_localdevice_photo_photo_proto_depIdxs = []int32{
	9, // 0: cloud.lazycat.apis.localdevice.PhotoMeta.creation_date:type_name -> google.protobuf.Timestamp
	5, // 1: cloud.lazycat.apis.localdevice.ListAlbumsReply.albums:type_name -> cloud.lazycat.apis.localdevice.Album
	6, // 2: cloud.lazycat.apis.localdevice.PhotoLibrary.ListAlbums:input_type -> cloud.lazycat.apis.localdevice.ListAlbumsRequest
	8, // 3: cloud.lazycat.apis.localdevice.PhotoLibrary.PutPhoto:input_type -> cloud.lazycat.apis.localdevice.PutPhotoRequest
	2, // 4: cloud.lazycat.apis.localdevice.PhotoLibrary.DeletePhoto:input_type -> cloud.lazycat.apis.localdevice.DeletePhotoRequest
	3, // 5: cloud.lazycat.apis.localdevice.PhotoLibrary.ListPhotoMetas:input_type -> cloud.lazycat.apis.localdevice.ListPhotoMetasRequest
	7, // 6: cloud.lazycat.apis.localdevice.PhotoLibrary.ListAlbums:output_type -> cloud.lazycat.apis.localdevice.ListAlbumsReply
	0, // 7: cloud.lazycat.apis.localdevice.PhotoLibrary.PutPhoto:output_type -> cloud.lazycat.apis.localdevice.PutPhotoReply
	1, // 8: cloud.lazycat.apis.localdevice.PhotoLibrary.DeletePhoto:output_type -> cloud.lazycat.apis.localdevice.DeletePhotoReply
	4, // 9: cloud.lazycat.apis.localdevice.PhotoLibrary.ListPhotoMetas:output_type -> cloud.lazycat.apis.localdevice.PhotoMeta
