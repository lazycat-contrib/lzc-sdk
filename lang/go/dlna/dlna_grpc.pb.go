...
const (
	RemoteMediaPlayerService_ScanRMP_FullMethodName         = "/lzc.dlna.RemoteMediaPlayerService/ScanRMP"
	RemoteMediaPlayerService_Subscribe_FullMethodName       = "/lzc.dlna.RemoteMediaPlayerService/Subscribe"
	RemoteMediaPlayerService_DoAction_FullMethodName        = "/lzc.dlna.RemoteMediaPlayerService/DoAction"
	RemoteMediaPlayerService_GetPositionInfo_FullMethodName = "/lzc.dlna.RemoteMediaPlayerService/GetPositionInfo"
)
...
type RemoteMediaPlayerServiceClient interface {
	...
	GetPositionInfo(ctx context.Context, in *GetPositionInfoRequest, opts ...grpc.CallOption) (*GetPositionInfoResponse, error)
}
...
func (c *remoteMediaPlayerServiceClient) ScanRMP(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ScanRMPResponse, error) {
	...
	err := c.cc.Invoke(ctx, RemoteMediaPlayerService_ScanRMP_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *remoteMediaPlayerServiceClient) Subscribe(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (RemoteMediaPlayerService_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &RemoteMediaPlayerService_ServiceDesc.Streams[0], RemoteMediaPlayerService_Subscribe_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *remoteMediaPlayerServiceClient) DoAction(ctx context.Context, in *DoActionRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, RemoteMediaPlayerService_DoAction_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *remoteMediaPlayerServiceClient) GetPositionInfo(ctx context.Context, in *GetPositionInfoRequest, opts ...grpc.CallOption) (*GetPositionInfoResponse, error) {
	out := new(GetPositionInfoResponse)
	err := c.cc.Invoke(ctx, RemoteMediaPlayerService_GetPositionInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RemoteMediaPlayerServiceServer interface {
	...
	GetPositionInfo(context.Context, *GetPositionInfoRequest) (*GetPositionInfoResponse, error)
...
func (UnimplementedRemoteMediaPlayerServiceServer) GetPositionInfo(context.Context, *GetPositionInfoRequest) (*GetPositionInfoResponse, error) {
...
func _RemoteMediaPlayerService_ScanRMP_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RemoteMediaPlayerService_ScanRMP_FullMethodName,
	}
...
func _RemoteMediaPlayerService_DoAction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RemoteMediaPlayerService_DoAction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RemoteMediaPlayerService_GetPositionInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RemoteMediaPlayerService_GetPositionInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RemoteMediaPlayerServiceServer).GetPositionInfo(ctx, req.(*GetPositionInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
