...
const (
	BrowserOnlyProxy_QuerySessionInfo_FullMethodName   = "/cloud.lazycat.apis.common.BrowserOnlyProxy/QuerySessionInfo"
	BrowserOnlyProxy_QueryAppInfo_FullMethodName       = "/cloud.lazycat.apis.common.BrowserOnlyProxy/QueryAppInfo"
	BrowserOnlyProxy_PairAllDevices_FullMethodName     = "/cloud.lazycat.apis.common.BrowserOnlyProxy/PairAllDevices"
	BrowserOnlyProxy_QueryAPIServerInfo_FullMethodName = "/cloud.lazycat.apis.common.BrowserOnlyProxy/QueryAPIServerInfo"
)
...
func (c *browserOnlyProxyClient) QuerySessionInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*SessionInfo, error) {
	out := new(SessionInfo)
	err := c.cc.Invoke(ctx, BrowserOnlyProxy_QuerySessionInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *browserOnlyProxyClient) QueryAppInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AppInfo, error) {
	out := new(AppInfo)
	err := c.cc.Invoke(ctx, BrowserOnlyProxy_QueryAppInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *browserOnlyProxyClient) PairAllDevices(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (BrowserOnlyProxy_PairAllDevicesClient, error) {
	stream, err := c.cc.NewStream(ctx, &BrowserOnlyProxy_ServiceDesc.Streams[0], BrowserOnlyProxy_PairAllDevices_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *browserOnlyProxyClient) QueryAPIServerInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*APIServerInfo, error) {
	...
	err := c.cc.Invoke(ctx, BrowserOnlyProxy_QueryAPIServerInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BrowserOnlyProxy_QuerySessionInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BrowserOnlyProxy_QuerySessionInfo_FullMethodName,
	}
...
func _BrowserOnlyProxy_QueryAppInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BrowserOnlyProxy_QueryAppInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BrowserOnlyProxy_QueryAPIServerInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BrowserOnlyProxy_QueryAPIServerInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var BrowserOnlyProxy_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.lazycat.apis.common.BrowserOnlyProxy",
	...
	Metadata: "common/browseronly.proto",
}
