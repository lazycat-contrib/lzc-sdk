...
type AppShortcut_IntentAction int32

const (
	// 未知
	AppShortcut_UN_kNOWN AppShortcut_IntentAction = 0
	// 打开
	AppShortcut_OPEN AppShortcut_IntentAction = 1
	// 分享
	AppShortcut_SHARE AppShortcut_IntentAction = 2
)

// Enum value maps for AppShortcut_IntentAction.
var (
	AppShortcut_IntentAction_name = map[int32]string{
		0: "UN_kNOWN",
		1: "OPEN",
		2: "SHARE",
	}
	AppShortcut_IntentAction_value = map[string]int32{
		"UN_kNOWN": 0,
		"OPEN":     1,
		"SHARE":    2,
	}
...
func (x AppShortcut_IntentAction) Enum() *AppShortcut_IntentAction {
	p := new(AppShortcut_IntentAction)
	*p = x
	return p
}

func (x AppShortcut_IntentAction) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (AppShortcut_IntentAction) Descriptor() protoreflect.EnumDescriptor {
	return file_common_file_handler_proto_enumTypes[0].Descriptor()
}

func (AppShortcut_IntentAction) Type() protoreflect.EnumType {
	return &file_common_file_handler_proto_enumTypes[0]
}

func (x AppShortcut_IntentAction) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use AppShortcut_IntentAction.Descriptor instead.
func (AppShortcut_IntentAction) EnumDescriptor() ([]byte, []int) {
	return file_common_file_handler_proto_rawDescGZIP(), []int{8, 0}
}
...
type AppShortcut struct {
	...
	IntentAction AppShortcut_IntentAction `protobuf:"varint,4,opt,name=intent_action,json=intentAction,proto3,enum=cloud.lazycat.apis.common.AppShortcut_IntentAction" json:"intent_action,omitempty"`
}
...
func (x *AppShortcut) GetIntentAction() AppShortcut_IntentAction {
	if x != nil {
		return x.IntentAction
	}
	return AppShortcut_UN_kNOWN
}
...
var file_common_file_handler_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x74, 0x22, 0xdb, 0x01, 0x0a, 0x0b, 0x41, 0x70, 0x70, 0x53, 0x68, 0x6f, 0x72, 0x74,
	...
	0x69, 0x63, 0x6f, 0x6e, 0x12, 0x58, 0x0a, 0x0d, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x5f, 0x61,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x33, 0x2e, 0x63, 0x6c,
	...
	0x63, 0x75, 0x74, 0x2e, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x52, 0x0c, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x31,
	0x0a, 0x0c, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x0c,
	0x0a, 0x08, 0x55, 0x4e, 0x5f, 0x6b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04,
	0x4f, 0x50, 0x45, 0x4e, 0x10, 0x01, 0x12, 0x09, 0x0a, 0x05, 0x53, 0x48, 0x41, 0x52, 0x45, 0x10,
	0x02, 0x32, 0xd9, 0x03, 0x0a, 0x0b, 0x46, 0x69, 0x6c, 0x65, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65,
	...
	0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x28, 0x01, 0x42, 0x2b, 0x5a,
...
var file_common_file_handler_proto_goTypes = []interface{}{
	(AppShortcut_IntentAction)(0),  // 0: cloud.lazycat.apis.common.AppShortcut.IntentAction
...
var file_common_file_handler_proto_depIdxs = []int32{
	9,  // 0: cloud.lazycat.apis.common.QueryReply.app_list:type_name -> cloud.lazycat.apis.common.AppShortcut
	0,  // 1: cloud.lazycat.apis.common.AppShortcut.intent_action:type_name -> cloud.lazycat.apis.common.AppShortcut.IntentAction
	7,  // 2: cloud.lazycat.apis.common.FileHandler.query:input_type -> cloud.lazycat.apis.common.QueryRequest
	5,  // 3: cloud.lazycat.apis.common.FileHandler.open:input_type -> cloud.lazycat.apis.common.OpenRequest
	4,  // 4: cloud.lazycat.apis.common.FileHandler.openFileManager:input_type -> cloud.lazycat.apis.common.OpenFileManagerRequest
	1,  // 5: cloud.lazycat.apis.common.FileHandler.walkDir:input_type -> cloud.lazycat.apis.common.WalkDirRequest
	3,  // 6: cloud.lazycat.apis.common.FileHandler.createDir:input_type -> cloud.lazycat.apis.common.CreateDirRequest
	8,  // 7: cloud.lazycat.apis.common.FileHandler.query:output_type -> cloud.lazycat.apis.common.QueryReply
	6,  // 8: cloud.lazycat.apis.common.FileHandler.open:output_type -> cloud.lazycat.apis.common.OpenReply
	10, // 9: cloud.lazycat.apis.common.FileHandler.openFileManager:output_type -> google.protobuf.Empty
	2,  // 10: cloud.lazycat.apis.common.FileHandler.walkDir:output_type -> cloud.lazycat.apis.common.WalkDirReply
	10, // 11: cloud.lazycat.apis.common.FileHandler.createDir:output_type -> google.protobuf.Empty
