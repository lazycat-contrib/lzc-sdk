...
type ListRemovableDiskReply struct {
	...
	//当前APP未挂载的磁盘列表
	Umounted []*RemovableFilesystemPartition `protobuf:"bytes,1,rep,name=umounted,proto3" json:"umounted,omitempty"`
	//当前APP已挂载的磁盘列表。
	Mounted []*RemovableFilesystemPartition `protobuf:"bytes,2,rep,name=mounted,proto3" json:"mounted,omitempty"`
}
...
func (x *ListRemovableDiskReply) GetUmounted() []*RemovableFilesystemPartition {
	if x != nil {
		return x.Umounted
	}
	return nil
...
func (x *ListRemovableDiskReply) GetMounted() []*RemovableFilesystemPartition {
	if x != nil {
		return x.Mounted
	}
	return nil
...
type RemovableFilesystemPartition struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RemovableFilesystemPartition) Reset() {
	*x = RemovableFilesystemPartition{}
	if protoimpl.UnsafeEnabled {
...
func (x *RemovableFilesystemPartition) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RemovableFilesystemPartition) ProtoMessage() {}

func (x *RemovableFilesystemPartition) ProtoReflect() protoreflect.Message {
	mi := &file_common_peripheral_device_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RemovableFilesystemPartition.ProtoReflect.Descriptor instead.
func (*RemovableFilesystemPartition) Descriptor() ([]byte, []int) {
	return file_common_peripheral_device_proto_rawDescGZIP(), []int{1}
}

func (x *RemovableFilesystemPartition) GetSource() string {
	if x != nil {
		return x.Source
	}
	return ""
...
func (x *RemovableFilesystemPartition) GetFstype() string {
	if x != nil {
		return x.Fstype
	}
	return ""
...
func (x *RemovableFilesystemPartition) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *RemovableFilesystemPartition) GetSize() uint64 {
	if x != nil {
		return x.Size
	}
	return 0
...
func (x *RemovableFilesystemPartition) GetUuid() string {
	if x != nil && x.Uuid != nil {
		return *x.Uuid
	}
	return ""
...
func (x *RemovableFilesystemPartition) GetMountpoint() string {
...
var file_common_peripheral_device_proto_rawDesc = []byte{
	...
	0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc0, 0x01, 0x0a, 0x16, 0x4c, 0x69, 0x73, 0x74,
	0x52, 0x65, 0x6d, 0x6f, 0x76, 0x61, 0x62, 0x6c, 0x65, 0x44, 0x69, 0x73, 0x6b, 0x52, 0x65, 0x70,
	0x6c, 0x79, 0x12, 0x53, 0x0a, 0x08, 0x75, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x64, 0x18, 0x01,
	...
	,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x22, 0x2c, 0x0a, 0x16, 0x4d, 0x6f, 0x75,
	...
	0x09, 0x52, 0x04, 0x75, 0x75, 0x69, 0x64, 0x22, 0x5b, 0x0a, 0x17, 0x55, 0x6d, 0x6f, 0x75, 0x6e,
	...
	0x72, 0x67, 0x65, 0x74, 0x22, 0x7e, 0x0a, 0x12, 0x4d, 0x6f, 0x75, 0x6e, 0x74, 0x57, 0x65, 0x62,
	0x44, 0x61, 0x76, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x72,
	...
	0x52, 0x0a, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x1a, 0x0a, 0x08,
	...
	0x77, 0x6f, 0x72, 0x64, 0x32, 0x9b, 0x03, 0x0a, 0x17, 0x50, 0x65, 0x72, 0x69, 0x70, 0x68, 0x65,
	0x72, 0x61, 0x6c, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x12, 0x60, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x61, 0x62, 0x6c,
	0x65, 0x44, 0x69, 0x73, 0x6b, 0x12, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70,
	...
	,
	...
	0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x12, 0x56, 0x0a, 0x0b, 0x4d, 0x6f,
...
var file_common_peripheral_device_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_common_peripheral_device_proto_goTypes = []interface{}{
	...
	(*RemovableFilesystemPartition)(nil), // 1: cloud.lazycat.apis.common.RemovableFilesystemPartition
	...
	(*MountWebDavRequest)(nil),           // 4: cloud.lazycat.apis.common.MountWebDavRequest
	(*emptypb.Empty)(nil),                // 5: google.protobuf.Empty
}
var file_common_peripheral_device_proto_depIdxs = []int32{
	1, // 0: cloud.lazycat.apis.common.ListRemovableDiskReply.umounted:type_name -> cloud.lazycat.apis.common.RemovableFilesystemPartition
	1, // 1: cloud.lazycat.apis.common.ListRemovableDiskReply.mounted:type_name -> cloud.lazycat.apis.common.RemovableFilesystemPartition
	5, // 2: cloud.lazycat.apis.common.PeripheralDeviceService.ListRemovableDisk:input_type -> google.protobuf.Empty
	2, // 3: cloud.lazycat.apis.common.PeripheralDeviceService.MountFilesystem:input_type -> cloud.lazycat.apis.common.MountFilesystemRequest
	3, // 4: cloud.lazycat.apis.common.PeripheralDeviceService.UmountFilesystem:input_type -> cloud.lazycat.apis.common.UmountFilesystemRequest
	4, // 5: cloud.lazycat.apis.common.PeripheralDeviceService.MountWebDav:input_type -> cloud.lazycat.apis.common.MountWebDavRequest
	0, // 6: cloud.lazycat.apis.common.PeripheralDeviceService.ListRemovableDisk:output_type -> cloud.lazycat.apis.common.ListRemovableDiskReply
	5, // 7: cloud.lazycat.apis.common.PeripheralDeviceService.MountFilesystem:output_type -> google.protobuf.Empty
	5, // 8: cloud.lazycat.apis.common.PeripheralDeviceService.UmountFilesystem:output_type -> google.protobuf.Empty
	5, // 9: cloud.lazycat.apis.common.PeripheralDeviceService.MountWebDav:output_type -> google.protobuf.Empty
...
func file_common_peripheral_device_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_common_peripheral_device_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RemovableFilesystemPartition); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
