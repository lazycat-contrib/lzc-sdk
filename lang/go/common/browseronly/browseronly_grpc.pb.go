...
func (c *browserOnlyProxyClient) QuerySessionInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*SessionInfo, error) {
	out := new(SessionInfo)
	err := c.cc.Invoke(ctx, "/cloud.lazycat.apis.common.BrowserOnlyProxy/QuerySessionInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *browserOnlyProxyClient) QueryAppInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AppInfo, error) {
	out := new(AppInfo)
	err := c.cc.Invoke(ctx, "/cloud.lazycat.apis.common.BrowserOnlyProxy/QueryAppInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *browserOnlyProxyClient) PairAllDevices(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (BrowserOnlyProxy_PairAllDevicesClient, error) {
	stream, err := c.cc.NewStream(ctx, &BrowserOnlyProxy_ServiceDesc.Streams[0], "/cloud.lazycat.apis.common.BrowserOnlyProxy/PairAllDevices", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *browserOnlyProxyClient) QueryAPIServerInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*APIServerInfo, error) {
	...
	err := c.cc.Invoke(ctx, "/cloud.lazycat.apis.common.BrowserOnlyProxy/QueryAPIServerInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BrowserOnlyProxy_QuerySessionInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cloud.lazycat.apis.common.BrowserOnlyProxy/QuerySessionInfo",
	}
...
func _BrowserOnlyProxy_QueryAppInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cloud.lazycat.apis.common.BrowserOnlyProxy/QueryAppInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BrowserOnlyProxy_QueryAPIServerInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cloud.lazycat.apis.common.BrowserOnlyProxy/QueryAPIServerInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var BrowserOnlyProxy_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "common/browseronly/browseronly.proto",
}
