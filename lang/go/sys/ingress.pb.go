...
var file_sys_ingress_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x55, 0x6e, 0x69, 0x78, 0x54, 0x69, 0x6d, 0x65, 0x32, 0xf5,
...
var file_sys_ingress_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_sys_ingress_proto_depIdxs = []int32{
	...
	4, // 4: cloud.lazycat.apis.sys.AccessControlerService.SetAppAccessPolicy:output_type -> google.protobuf.Empty
	1, // 5: cloud.lazycat.apis.sys.AccessControlerService.QueryAppAccessPolicy:output_type -> cloud.lazycat.apis.sys.AppAccessPolicy
	3, // 6: cloud.lazycat.apis.sys.AccessControlerService.GetAppLastAccessTime:output_type -> cloud.lazycat.apis.sys.IngressAppLastAccessTimeResponse
